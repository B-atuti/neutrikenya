...
Write-Host "Step 1: Downloading hair care products and images from neutriherbs.com..."
...
Write-Host "Step 3: Importing hair care products into the Django database..."
