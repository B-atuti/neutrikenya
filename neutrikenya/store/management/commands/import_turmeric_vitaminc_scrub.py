...
class Command(BaseCommand):
    help = 'Import Turmeric & Vitamin C Body Scrub images from static folder to media folder and create product'

    def handle(self, *args, **options):
        # Get the project root directory
        project_root = os.path.dirname(os.path.dirname(os.path.dirname(os.path.dirname(os.path.abspath(__file__)))))
        
        # Source directory for scrub images
        source_dir = os.path.join(project_root, 'static', 'images', 'Turmeric & Vitamin C Body Scrub')
        ...
        product_name = 'Turmeric & Vitamin C Body Scrub'
        ...
        product, created = Product.objects.get_or_create(
            ...
            defaults={
                ...
                'price': 2800.00,
                'description': 'A powerful exfoliating body scrub that combines the brightening benefits of Vitamin C with the anti-inflammatory properties of Turmeric for smooth, glowing skin.',
