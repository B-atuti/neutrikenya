...
class Command(BaseCommand):
    help = 'Import Vitamin C Body Lotion images from static folder to media folder and create product'
    ...
    def handle(self, *args, **options):
        ...
        source_dir = os.path.join(project_root, 'static', 'images', 'Vitamin C Body Lotion')
        ...
        product_name = 'Vitamin C Body Lotion'
        ...
        product, created = Product.objects.get_or_create(
            ...
            defaults={
                ...
                'price': 2300.00,
                'description': 'A lightweight, fast-absorbing body lotion enriched with Vitamin C to hydrate, protect, and brighten your skin. This nourishing formula helps to even out skin tone, reduce the appearance of dark spots, and leave your skin feeling soft, smooth, and radiant.',
