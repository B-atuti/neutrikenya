...
class Command(BaseCommand):
    help = 'Import Vitamin C Cream images from static folder to media folder and create product'
    ...
    def handle(self, *args, **options):
        ...
        source_dir = os.path.join(project_root, 'static', 'images', 'CREAM')
        ...
        product, created = Product.objects.get_or_create(
            ...
            defaults={
                ...
                'price': 2500.00,
                'description': 'A luxurious cream enriched with Vitamin C to brighten skin, reduce dark spots, and promote a radiant complexion. This deeply moisturizing formula helps to even out skin tone, minimize the appearance of fine lines, and leave your skin looking refreshed and glowing.',
