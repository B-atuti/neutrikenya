...
class Command(BaseCommand):
    help = 'Import Pro Retinol Serum images from static folder to media folder and create product'
    ...
    def handle(self, *args, **options):
        ...
        source_dir = os.path.join(project_root, 'static', 'images', 'PRO RETINOL SERUM')
        ...
        product_name = 'Pro Retinol Serum'
        ...
        product, created = Product.objects.get_or_create(
            ...
            defaults={
                ...
                'price': 1700.00,
                'description': 'A powerful serum formulated with advanced retinol to target signs of aging, improve skin texture, and promote cellular renewal. This concentrated formula helps to reduce the appearance of fine lines and wrinkles while enhancing skin firmness and elasticity. Regular use helps to achieve a more youthful, radiant complexion.',
                'product_line': 'Pro Retinol',
                'skin_concern': 'Aging, Fine Lines, Uneven Skin Texture',
                'is_available': True
            }
        )
