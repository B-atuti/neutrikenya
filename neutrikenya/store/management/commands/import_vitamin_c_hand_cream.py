...
class Command(BaseCommand):
    help = 'Import Vitamin C Hand Cream images from static folder to media folder and create product'
    ...
    def handle(self, *args, **options):
        ...
        source_dir = os.path.join(project_root, 'static', 'images', 'HAND CREAM')
        ...
        product_name = 'Vitamin C Hand Cream'
        ...
        product, created = Product.objects.get_or_create(
            ...
            defaults={
                ...
                'price': 1400.00,
                'description': 'A nourishing hand cream enriched with Vitamin C to hydrate, protect, and brighten your hands. This fast-absorbing formula helps to smooth dry, rough skin while providing antioxidant protection and promoting a more even skin tone.',
                'product_line': 'Vitamin C',
                'skin_concern': 'Dry Hands, Rough Skin, Uneven Skin Tone',
                'is_available': True
            }
        )
