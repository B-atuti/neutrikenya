...
class Command(BaseCommand):
    help = 'Import Pro Retinol Cream images from static folder to media folder and create product'

    def handle(self, *args, **options):
        # Get the project root directory
        project_root = os.path.dirname(os.path.dirname(os.path.dirname(os.path.dirname(os.path.abspath(__file__)))))
        
        # Source directory for cream images
        source_dir = os.path.join(project_root, 'static', 'images', 'PRO RETINOL CREAM')
        ...
        product_name = 'Pro Retinol Cream'
        ...
        product, created = Product.objects.get_or_create(
            ...
            defaults={
                ...
                'price': 2300.00,
                'description': 'A luxurious cream enriched with advanced retinol to deeply nourish and rejuvenate the skin. This rich, emollient formula helps to improve skin elasticity, reduce the appearance of fine lines and wrinkles, and promote a more youthful complexion. The cream provides intense hydration while delivering the powerful anti-aging benefits of retinol.',
                'product_line': 'Pro Retinol',
                'skin_concern': 'Aging, Fine Lines, Loss of Elasticity',
                'is_available': True
            }
        )
