...
class Command(BaseCommand):
    help = 'Import Ultra Hydrating Night Cream images from static folder to media folder and create product'

    def handle(self, *args, **options):
        # Get the project root directory
        project_root = os.path.dirname(os.path.dirname(os.path.dirname(os.path.dirname(os.path.abspath(__file__)))))
        
        # Source directory for night cream images
        source_dir = os.path.join(project_root, 'static', 'images', 'Ultra Hydrating Night cream')
        ...
        product_name = 'Ultra Hydrating Night Cream'
        ...
        product, created = Product.objects.get_or_create(
            ...
            defaults={
                ...
                'price': 2300.00,
                'description': 'A rich, deeply nourishing night cream that works while you sleep to provide intense hydration and skin repair. This luxurious formula helps to replenish moisture, strengthen the skin barrier, and wake up to a softer, smoother, and more radiant complexion.',
