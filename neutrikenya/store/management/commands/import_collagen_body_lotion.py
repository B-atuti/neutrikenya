...
class Command(BaseCommand):
    help = 'Import Collagen Body Lotion images from static folder to media folder and create product'
    ...
    def handle(self, *args, **options):
        ...
        source_dir = os.path.join(project_root, 'static', 'images', 'Collagen Body Lotion')
        ...
        product_name = 'Collagen Body Lotion'
        ...
        product, created = Product.objects.get_or_create(
            ...
            defaults={
                ...
                'price': 2300.00,
                'description': 'A luxurious body lotion enriched with collagen to help improve skin elasticity and firmness all over the body. This deeply moisturizing formula helps to reduce the appearance of fine lines and stretch marks while providing long-lasting hydration. The lotion absorbs quickly without leaving a greasy residue, making it perfect for daily use. Regular application helps to maintain skin\'s natural collagen levels and promotes a more youthful, radiant appearance.',
                'product_line': 'Collagen',
                'skin_concern': 'Aging, Loss of Elasticity, Dry Skin',
                'is_available': True
            }
        )
