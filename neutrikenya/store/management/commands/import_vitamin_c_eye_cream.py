...
class Command(BaseCommand):
    help = 'Import Vitamin C Eye Cream images from static folder to media folder and create product'
    ...
    def handle(self, *args, **options):
        ...
        source_dir = os.path.join(project_root, 'static', 'images', 'EYE CREAM')
