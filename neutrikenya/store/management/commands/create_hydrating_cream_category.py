...
class Command(BaseCommand):
    help = 'Create Hydrating Cream category'

    def handle(self, *args, **options):
        category_name = 'Hydrating Cream'
        ...
        category, created = Category.objects.get_or_create(
            ...
            defaults={
                'slug': category_slug,
                'description': 'Products formulated with powerful hydrating ingredients to deeply moisturize, nourish, and restore the skin\'s natural moisture barrier for a healthy, radiant complexion.'
            }
        )
