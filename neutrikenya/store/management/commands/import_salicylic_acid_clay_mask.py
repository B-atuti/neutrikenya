...
class Command(BaseCommand):
    help = 'Import Salicylic Acid Clay Mask images from static folder to media folder and create product'

    def handle(self, *args, **options):
        # Get the project root directory
        project_root = os.path.dirname(os.path.dirname(os.path.dirname(os.path.dirname(os.path.abspath(__file__)))))
        
        # Source directory for clay mask images
        source_dir = os.path.join(project_root, 'static', 'images', 'SALICYLIC ACID CLAY MASK')
        ...
        product_name = 'Salicylic Acid Clay Mask'
        ...
        product, created = Product.objects.get_or_create(
            ...
            defaults={
                ...
                'price': 1600.00,
                'description': 'A powerful clay mask infused with Salicylic Acid to deeply purify and clarify the skin. This detoxifying formula helps to draw out impurities, absorb excess oil, and unclog pores while providing gentle exfoliation. Regular use helps to reduce breakouts, minimize the appearance of pores, and leave your skin feeling refreshed and balanced.',
