...
class Command(BaseCommand):
    help = 'Import Salicylic Acid Serum images from static folder to media folder and create product'
    ...
    def handle(self, *args, **options):
        ...
        source_dir = os.path.join(project_root, 'static', 'images', 'SALICYLIC ACID SERUM')
        ...
        product_name = 'Salicylic Acid Serum'
        ...
        product, created = Product.objects.get_or_create(
            ...
            defaults={
                ...
                'price': 1900.00,
                'description': 'A concentrated serum formulated with Salicylic Acid to target acne and blemishes at their source. This powerful yet gentle formula helps to exfoliate dead skin cells, unclog pores, and reduce inflammation while promoting clearer, healthier-looking skin. Regular use helps to prevent breakouts and improve overall skin texture.',
                'product_line': 'Salicylic Acid',
                'skin_concern': 'Acne, Blemishes, Uneven Skin Texture',
                'is_available': True
            }
        )
