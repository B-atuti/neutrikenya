...
class Command(BaseCommand):
    help = 'Import Collagen Facial Sheet Mask images from static folder to media folder and create product'
    ...
    def handle(self, *args, **options):
        ...
        source_dir = os.path.join(project_root, 'static', 'images', 'Collagen Facial Sheet Mask')
        ...
        product, created = Product.objects.get_or_create(
            ...
            defaults={
                ...
                'price': 2400.00,
                'description': 'A luxurious sheet mask infused with collagen to provide an instant boost of hydration and firmness. Each pack contains 4 masks, perfect for a month of weekly treatments. The mask helps to improve skin elasticity, reduce the appearance of fine lines, and leave your skin feeling plump and radiant. The convenient sheet format ensures even distribution of the collagen-rich essence for maximum benefits.',
                'product_line': 'Collagen',
                'skin_concern': 'Aging, Loss of Elasticity, Dull Skin',
                'is_available': True
            }
        )
