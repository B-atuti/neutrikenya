...
class Command(BaseCommand):
    help = 'Import Lighten Skin Facial Cleanser images from static folder to media folder and create product'
    ...
    def handle(self, *args, **options):
        ...
        source_dir = os.path.join(project_root, 'static', 'images', 'LIGHTEN SKIN FACIAL CLEANSER')
        ...
        product_name = 'Lighten Skin Facial Cleanser'
