...
class Command(BaseCommand):
    help = 'Import Pro Retinol Cleanser images from static folder to media folder and create product'
    ...
    def handle(self, *args, **options):
        ...
        source_dir = os.path.join(project_root, 'static', 'images', 'PRO RETINOL CLEANSER')
        ...
        product_name = 'Pro Retinol Cleanser'
        ...
        product, created = Product.objects.get_or_create(
            ...
            defaults={
                ...
                'price': 1400.00,
                'description': 'A gentle yet effective cleanser formulated with retinol to help remove impurities while providing anti-aging benefits. This daily cleanser helps to unclog pores, remove makeup and dirt, and prepare the skin for better absorption of subsequent skincare products. The formula is designed to be gentle enough for daily use while delivering the benefits of retinol.',
                'product_line': 'Pro Retinol',
                'skin_concern': 'Aging, Dull Skin, Clogged Pores',
                'is_available': True
            }
        )
