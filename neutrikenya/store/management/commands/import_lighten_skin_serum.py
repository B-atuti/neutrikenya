...
class Command(BaseCommand):
    help = 'Import Lighten Skin Serum images from static folder to media folder and create product'
    ...
    def handle(self, *args, **options):
        ...
        source_dir = os.path.join(project_root, 'static', 'images', 'LIGHTEN SKIN SERUM')
        ...
        product_name = 'Lighten Skin Serum'
        ...
        product, created = Product.objects.get_or_create(
            ...
            defaults={
                ...
                'price': 3500.00,
                'description': 'A powerful serum formulated with natural ingredients to help brighten and even out skin tone. This concentrated formula helps reduce the appearance of dark spots and hyperpigmentation while promoting a more radiant, glowing complexion.',
