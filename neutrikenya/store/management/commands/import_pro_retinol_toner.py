...
class Command(BaseCommand):
    help = 'Import Pro Retinol Toner images from static folder to media folder and create product'
    ...
    def handle(self, *args, **options):
        ...
        source_dir = os.path.join(project_root, 'static', 'images', 'PRO RETINOL TONER')
        ...
        product_name = 'Pro Retinol Toner'
        ...
        product, created = Product.objects.get_or_create(
            ...
            defaults={
                ...
                'price': 1900.00,
                'description': 'A balancing toner enriched with retinol to help refine pores, even skin tone, and enhance the effectiveness of your skincare routine. This gentle formula helps to remove any remaining impurities while delivering the anti-aging benefits of retinol. The toner helps to prepare the skin for better absorption of subsequent products while providing additional anti-aging benefits.',
                'product_line': 'Pro Retinol',
                'skin_concern': 'Aging, Uneven Skin Tone, Enlarged Pores',
                'is_available': True
            }
        )
