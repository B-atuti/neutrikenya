...
class Command(BaseCommand):
    help = 'Import Lighten Skin Soap images from static folder to media folder and create product'
    ...
    def handle(self, *args, **options):
        ...
        source_dir = os.path.join(project_root, 'static', 'images', 'LIGHTEN SKIN SOAP')
        ...
        product_name = 'Lighten Skin Soap'
        ...
        product, created = Product.objects.get_or_create(
            ...
            defaults={
                ...
                'price': 1200.00,
                'description': 'A nourishing soap bar enriched with natural ingredients to help brighten and even out skin tone. This gentle yet effective soap helps reduce the appearance of dark spots and hyperpigmentation while cleansing and moisturizing the skin.',
