...
class Command(BaseCommand):
    help = 'Import Vitamin C Cleansing Oil images from static folder to media folder and create product'

    def handle(self, *args, **options):
        # Get the project root directory
        project_root = os.path.dirname(os.path.dirname(os.path.dirname(os.path.dirname(os.path.abspath(__file__)))))
        
        # Source directory for cleansing oil images
        source_dir = os.path.join(project_root, 'static', 'images', 'Cleansing Oil')
        ...
        product_name = 'Vitamin C Cleansing Oil'
        ...
        product, created = Product.objects.get_or_create(
            ...
            defaults={
                ...
                'price': 2400.00,
                'description': 'A gentle yet effective cleansing oil enriched with Vitamin C to remove makeup, dirt, and impurities while brightening skin. This lightweight formula helps to dissolve excess oil, unclog pores, and leave your skin feeling clean, refreshed, and radiant.',
                'product_line': 'Vitamin C',
                'skin_concern': 'Dull Skin, Clogged Pores, Uneven Skin Tone',
                'is_available': True
            }
        )
