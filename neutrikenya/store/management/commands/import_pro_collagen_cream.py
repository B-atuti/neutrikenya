...
class Command(BaseCommand):
    help = 'Import Pro Collagen Cream images from static folder to media folder and create product'
    ...
    def handle(self, *args, **options):
        ...
        source_dir = os.path.join(project_root, 'static', 'images', 'PRO COLLAGEN CREAM')
        ...
        product_name = 'Pro Collagen Cream'
        ...
        product, created = Product.objects.get_or_create(
            ...
            defaults={
                ...
                'price': 3000.00,
                'description': 'A premium anti-aging cream enriched with collagen to help improve skin elasticity and firmness. This luxurious formula helps to reduce the appearance of fine lines and wrinkles while providing deep hydration. The cream works to support your skin\'s natural collagen production, resulting in a more youthful and radiant complexion.',
                'product_line': 'Pro Collagen',
