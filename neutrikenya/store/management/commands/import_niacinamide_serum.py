...
class Command(BaseCommand):
    help = 'Import Niacinamide Serum images from static folder to media folder and create product'
    ...
    def handle(self, *args, **options):
        ...
        source_dir = os.path.join(project_root, 'static', 'images', 'Niacinamide SERUM')
        ...
        product, created = Product.objects.get_or_create(
            ...
            defaults={
                ...
                'price': 1700.00,
                'description': 'A powerful serum formulated with Niacinamide (Vitamin B3) to help improve skin texture and tone. This lightweight formula helps to reduce the appearance of pores, control excess oil production, and strengthen the skin barrier. The serum helps to minimize redness, even out skin tone, and improve overall skin clarity. Regular use helps to reveal smoother, more balanced skin.',
                'product_line': 'Serums',
                'skin_concern': 'Oily Skin, Large Pores, Uneven Skin Tone',
                'is_available': True
            }
        )
